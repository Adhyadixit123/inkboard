...
export function AdminSetupClient({ token, expiresAt }: AdminSetupClientProps) {
    ...
    const [displayName, setDisplayName] = useState('Inkboard Admin');
                ...
                {success ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div>
                            ...
                            <input className="input" type="email" placeholder="admin@inkboard.eu" required value={email} onChange={e => setEmail(e.target.value)} />
                        </div>
                        <div>
